...
test("uses independently isolated assets at the original 1920x1068 coordinates", async () => {
  ...
  assert.match(hero, /wristMaximumRotation: 0\.25/);
  assert.match(hero, /wristContactPress: 0\.1/);
  assert.match(hero, /wristHorizontalSweep: 1\.1/);
  assert.match(hero, /wristHorizontalSweep: 0\.2/);
  ...
  assert.match(hero, /wristLiftHeight: 0\.32/);
  ...
  assert.match(hero, /maximumRotation: 2\.9/);
  assert.match(hero, /strokeBlend: 0\.62/);
  assert.match(hero, /detailLimit: 0\.3/);
  assert.match(hero, /detailStrength: 0\.07/);
  assert.match(hero, /liftRotation: -0\.53/);
  assert.match(hero, /liftRotation: 0\.55/);
  assert.match(hero, /const goldActorCadence = \[2\.5, -2\.6, 2\.3, -2\.5, 2\.2, -2\.35, 2\.05\]/);
